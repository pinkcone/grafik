...
const HIGHLIGHT_VARIANTS = ['green', 'rose'];
        ...
        <tbody>
          {employees.map((emp, index) => {
            const isHighlighted =
              ...
              highlightedEmployeeId.toString() === emp.id.toString();
            const highlightVariant = HIGHLIGHT_VARIANTS[index % HIGHLIGHT_VARIANTS.length];
            const rowClass = isHighlighted
              ? `schedule-table__row--highlighted schedule-table__row--highlight-${highlightVariant}`
              : '';
